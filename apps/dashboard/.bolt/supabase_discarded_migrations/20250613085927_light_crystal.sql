/*
  ...
  1. User Profile Table
    ...
    - Tracks organization membership and business unit access
    - Stores user preferences and activity data

  2. Organization User Roles
    - Enhanced role-based access control
    - Support for multiple business units per user
...
-- Update the existing organization_users table to be compatible
-- (Keep it for backward compatibility but migrate to new system)
