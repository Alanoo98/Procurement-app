                  ...
                  <ProtectedRoute>
                    <div className="flex h-screen bg-gray-100">
                      ...
                      <div className="flex-1 flex flex-col overflow-hidden px-8">
                        {universe === 'procurement' && <GlobalFilters />}
                        <div className="flex-1 overflow-auto -mx-8 px-4">
                          <Routes>
                            ...
                            <Route path="/stock/reports" element={<div className="p-8"><h1 className="text-2xl font-bold">Stock Reports</h1><p className="text-gray-600">Coming soon...</p></div>} />
