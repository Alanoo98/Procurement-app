-- Apply improved category triggers with better matching strategy
-- This script updates the triggers to use product code + supplier as primary identifiers
...
-- Show confirmation
SELECT 'Improved category triggers applied successfully!' as status;
