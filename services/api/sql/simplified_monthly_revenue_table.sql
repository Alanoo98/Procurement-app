-- Simplified monthly_revenue table that uses currency string directly
-- This leverages the existing currency column in invoice_lines

-- Drop the existing table if it exists (for clean migration)
DROP TABLE IF EXISTS public.monthly_revenue CASCADE;

-- Create the simplified monthly_revenue table
